...
CatBoost_preds_test = pd.DataFrame(preds).apply(np.mean, axis = 0)
submission['booking_status'] = CatBoost_preds_test

file_name = 'CatBoost_FS_Seed_' + str(SEED) + '_CV_Score.csv'
