...
for i in tqdm(range(0, 10)):
    ...
    auto_feature_selection = RFECV(estimator = LGBMRegressor(), step = 1, min_features_to_select = 2, cv = 5, scoring = 'neg_root_mean_squared_error', n_jobs = -1).fit(X, Y)
...
file_name = 'LGBM_Seed_FE_FS_' + str(SEED) + '_Optuna_Hyperparameters.csv'
