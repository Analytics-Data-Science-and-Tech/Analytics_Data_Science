...
file_name = 'XGBoost_Seed_' + str(SEED) + '_Optuna_Hyperparameters.csv'
...
xgb_preds = pd.DataFrame(preds).mean(axis = 0)
submission['sleep_hours'] =  xgb_preds
submission.to_csv('xgb_baseline_optuna_submission.csv', index = False)