...
class Objective:
    ...
    def __call__(self, trial):
        ...
        param = dict(n_estimators = trial.suggest_int('n_estimators', 30, 10000), 
                     max_depth = trial.suggest_int('max_depth', 2, 15),
                     min_samples_leaf = trial.suggest_int('min_samples_leaf', 20, 100),
                     min_samples_split = trial.suggest_int('min_samples_leaf', 20, 100)
                    )
...
file_name = 'man_RF_Phase_1_' + str(SEED) + '_Optuna_Hyperparameters.csv'
